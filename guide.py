...
TEACHER_GUIDE = [
    ...
    ("Assigning, scheduling and results", [
        ...
        ("note", "Once a real student starts an assessment, its settings and its questions become read-only - including the order the questions are in. Your own preview attempts from Student view do not count."),
...
STUDENT_GUIDE = [
    ...
    ("Taking an assessment", [
        ...
        ("ul", [
            ...
            "Submitting with questions still blank asks you first, and tells you which numbers they are, so a question you meant to come back to is not handed in empty by accident. If the clock runs out it submits without asking - so keep an eye on it.",
